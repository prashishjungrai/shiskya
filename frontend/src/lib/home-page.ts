...
export const HOME_PAGE_DEFAULTS: HomePageSettings = {
  command_bar: {
    ...
    quick_actions: [
      ...
      },
      {
        ...
        description: "Open the testimonials page and review visible student outcomes.",
        href: "/testimonials",
        meta: "Proof",
      },
      {
        id: "study-resources",
        title: "Open study resources",
        description: "Browse guides for exam strategy, revision, and syllabus planning.",
        href: "/resources",
        meta: "Resources",
      },
    ].slice(0, 4),
  ...
  hero: {
    badge_text: "+2 and engineering tuition",
    title: "Bidhya Kendra",
    description: "Exam-focused learning support for +2 and engineering students in Nepal",
